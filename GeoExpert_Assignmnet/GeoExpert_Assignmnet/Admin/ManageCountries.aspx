<%@ Page Title="Manage Countries" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageCountries.aspx.cs" Inherits="GeoExpert_Assignment.Admin.ManageCountries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Manage Countries 🌍</h2>
    
    <!-- TODO: Member D - CRUD operations for countries -->
    ...
    <div class="add-section">
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="Update Country" CssClass="btn btn-primary" Visible="false" OnClick="btnUpdate_Click" />
        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn" Visible="false" OnClick="btnCancel_Click" />
            ...
            <asp:TemplateField HeaderText="Actions">
                <ItemTemplate>
                    ...
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" 
                                CommandName="DeleteCountry" 
                                CommandArgument='<%# Eval("CountryID") %>' 
                                CssClass="btn btn-danger" 
                                OnClientClick="return confirm('Are you sure you want to delete this country?');" CausesValidation="false" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
