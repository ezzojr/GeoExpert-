...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="profile-container">
        <div class="profile-info">
            ...
            <p>Role: <asp:Literal ID="litRole" runat="server"></asp:Literal></p>
            
            <!-- Only show for regular users -->
            <asp:Panel ID="pnlUserStats" runat="server" Visible="false">
        ...
        <!-- Badges section - only for regular users -->
        ...
        <!-- Quiz history - only for regular users -->
